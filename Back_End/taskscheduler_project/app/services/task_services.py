...
async def create_task(task_data: TaskCreate, user_email: str):
    try:
        ...
        return {"message": "Task created successfully", "status": "success", "task": task}
    except Exception as e:
        return {"message": f"Task creation failed: {str(e)}", "status": "error"}
...
async def update_task(task_id: str, task_data: TaskUpdate, user_email: str):
    try:
        ...
        return {"message": f"Task update failed: {str(e)}", "status": "error"}
